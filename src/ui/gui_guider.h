...
typedef struct
{
	...
	lv_obj_t *screen_tickets_cont_2;
	lv_obj_t *screen_tickets_label_13;
	lv_obj_t *screen_tickets_label_14;
...
LV_IMAGE_DECLARE(_waiting1_RGB565A8_86x36);
LV_IMAGE_DECLARE(_unbind1_RGB565A8_128x109);
