...
void setup_scr_screen_tickets(lv_ui *ui) {
    ...
    lv_obj_set_size(ui->screen_tickets_cont_1, 320, 37);
    ...
    lv_obj_set_pos(ui->screen_tickets_img_user, 9, 4);
    ...
    // Write codes screen_tickets_lb_nickname
    ui->screen_tickets_lb_nickname = lv_label_create(ui->screen_tickets_cont_1);
    lv_obj_set_pos(ui->screen_tickets_lb_nickname, 47, 10);
    lv_obj_set_size(ui->screen_tickets_lb_nickname, 153, 20);
    lv_label_set_text(ui->screen_tickets_lb_nickname, "骑猪看风景...");
    lv_label_set_long_mode(ui->screen_tickets_lb_nickname, LV_LABEL_LONG_WRAP);

    // Write style for screen_tickets_lb_nickname, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_tickets_lb_nickname, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_tickets_lb_nickname, LV_FONT_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_tickets_lb_nickname, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_tickets_lb_nickname, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_tickets_lb_nickname, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes screen_tickets_lb_user_id
    ui->screen_tickets_lb_user_id = lv_label_create(ui->screen_tickets_cont_1);
    lv_obj_set_pos(ui->screen_tickets_lb_user_id, 224, 10);
    ...
    lv_obj_set_pos(ui->screen_tickets_label_6, 6, 57);
    lv_obj_set_size(ui->screen_tickets_label_6, 90, 25);
    lv_label_set_text(ui->screen_tickets_label_6, "获得彩票");
    ...
    lv_obj_set_style_text_font(ui->screen_tickets_label_6, LV_FONT_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->screen_tickets_label_6, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write codes screen_tickets_label_7
    ui->screen_tickets_label_7 = lv_label_create(ui->screen_tickets);
    lv_obj_set_pos(ui->screen_tickets_label_7, 6, 98);
    lv_obj_set_size(ui->screen_tickets_label_7, 90, 25);
    lv_label_set_text(ui->screen_tickets_label_7, "已存彩票");
    lv_label_set_long_mode(ui->screen_tickets_label_7, LV_LABEL_LONG_WRAP);

    // Write style for screen_tickets_label_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_tickets_label_7, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_tickets_label_7, LV_FONT_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_tickets_label_7, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_tickets_label_7, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_tickets_label_7, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    // Write codes screen_tickets_label_9
    ui->screen_tickets_label_9 = lv_label_create(ui->screen_tickets);
    lv_obj_set_pos(ui->screen_tickets_label_9, 6, 136);
    lv_obj_set_size(ui->screen_tickets_label_9, 90, 25);
    lv_label_set_text(ui->screen_tickets_label_9, "待存彩票");
    lv_label_set_long_mode(ui->screen_tickets_label_9, LV_LABEL_LONG_WRAP);

    // Write style for screen_tickets_label_9, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_tickets_label_9, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_tickets_label_9, LV_FONT_DEFAULT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_tickets_label_9, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_tickets_label_9, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_tickets_label_9, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_tickets_btn_save_exit, &lv_font_montserratMedium_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->screen_tickets_progress_bar, 302, 8);
    ...
    // Write codes screen_tickets_cont_2
    ui->screen_tickets_cont_2 = lv_obj_create(ui->screen_tickets);
    lv_obj_set_pos(ui->screen_tickets_cont_2, 10, 70);
    lv_obj_set_size(ui->screen_tickets_cont_2, 300, 126);
    lv_obj_set_scrollbar_mode(ui->screen_tickets_cont_2, LV_SCROLLBAR_MODE_OFF);
    lv_obj_add_flag(ui->screen_tickets_cont_2, LV_OBJ_FLAG_HIDDEN);

    // Write style for screen_tickets_cont_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_tickets_cont_2, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_tickets_cont_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_tickets_cont_2, lv_color_hex(0x2195f6), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_tickets_cont_2, LV_BORDER_SIDE_FULL, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_tickets_cont_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_tickets_cont_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_tickets_cont_2, lv_color_hex(0xf3f3f3), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_tickets_cont_2, LV_GRAD_DIR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_tickets_cont_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_tickets_cont_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_tickets_cont_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_tickets_cont_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_tickets_cont_2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes screen_tickets_label_13
    ui->screen_tickets_label_13 = lv_label_create(ui->screen_tickets_cont_2);
    lv_obj_set_pos(ui->screen_tickets_label_13, 57, 17);
    lv_obj_set_size(ui->screen_tickets_label_13, 199, 67);
    lv_label_set_text(ui->screen_tickets_label_13, "自动保存中\n请稍后");
    lv_label_set_long_mode(ui->screen_tickets_label_13, LV_LABEL_LONG_WRAP);

    // Write style for screen_tickets_label_13, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_tickets_label_13, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_tickets_label_13, &lv_font_montserratMedium_25, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_tickets_label_13, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_tickets_label_13, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_tickets_label_13, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes screen_tickets_label_14
    ui->screen_tickets_label_14 = lv_label_create(ui->screen_tickets_cont_2);
    lv_obj_set_pos(ui->screen_tickets_label_14, 71, 93);
    lv_obj_set_size(ui->screen_tickets_label_14, 172, 18);
    lv_label_set_text(ui->screen_tickets_label_14, "每15秒自动上传保存");
    lv_label_set_long_mode(ui->screen_tickets_label_14, LV_LABEL_LONG_WRAP);

    // Write style for screen_tickets_label_14, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_tickets_label_14, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_tickets_label_14, &lv_font_montserratMedium_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_tickets_label_14, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_tickets_label_14, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_tickets_label_14, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
