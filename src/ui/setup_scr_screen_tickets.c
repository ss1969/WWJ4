...
void setup_scr_screen_tickets(lv_ui *ui)
{
    ...
    ui->screen_tickets_lb_nickname = lv_label_create(ui->screen_tickets);
    lv_obj_set_pos(ui->screen_tickets_lb_nickname, 40, 9);
    lv_obj_set_size(ui->screen_tickets_lb_nickname, 186, 23);
    ...
    lv_obj_set_style_text_font(ui->screen_tickets_lb_nickname, &lv_font_NotoSansCJKscMedium_18, LV_PART_MAIN|LV_STATE_DEFAULT);
